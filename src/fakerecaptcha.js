const questions = [
  ...
  {
    questionP1: "What is the ",
    bold: "574th",
    questionP2: "digit of pi?",
    answer: "7",
    imgbox: false,
  },
  {
  ...
  {
    questionP1: "Enter the",
    bold: "SHA256",
    questionP2: "hash of 'edad5a2'",
    answer: "d3b2e313a3c282b54da40e4d420e02b899c67a5b1a0bc582da80db6111b6e2399",
    imgbox: false,
  },
];
...
function loadQuestion() {
  if (questions[currentQuestionIndex].imgbox) {
    document.getElementById("img-box").style.backgroundColor =
      questions[currentQuestionIndex].answer;
  }
  document.getElementById("result-text").innerText = "";
  document.getElementById("answer-input").value = "";

  document.getElementById("question-P1").innerText =
    questions[currentQuestionIndex].questionP1;
  document.getElementById("question-bold").innerText =
    questions[currentQuestionIndex].bold;
  document.getElementById("question-P2").innerText =
    questions[currentQuestionIndex].questionP2;
}
